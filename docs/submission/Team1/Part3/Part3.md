...
而执行value估计我们依据对家的棋子坐标代数和，人为的将估计分为三个阶段：前期、中期和后期。前期以尽可能往前走为目标，走的越靠前，就越能干扰对方的部署，防止对方背谱；同时对离开自家大营的棋子给予奖励；中期以整体战线往前推进为目的，惩罚尚未离开大营的棋子，少量奖励进入对方大营的棋子，同时控制不要过度偏离中线；后期以不留子为目的，尽可能控制顽固分子拉帮结派前往大营，增大对偏离中线的惩罚。  
